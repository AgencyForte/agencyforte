  ...
  useEffect(() => {
    ...
    const searchAgencies = async () => {
      ...
      if (!error && data && data.length > 0) {
        // Dynamically fetch exact active carrier count to build authority
        ...
        <div className="glass-card">
          <div className="onboarding-header" style={{ textAlign: 'center', marginBottom: '2rem' }}>
            ...
            {step === 1 ? (
              ...
              <>
                <h2 style={{ fontSize: '2.5rem', marginBottom: '0.5rem' }}>Select Priority Targets</h2>
                <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem' }}>
                  Target up to 5 competitors to deploy to your Intelligence Dashboard.
                </p>
              </>
            )}
          </div>
          ...
          {step === 1 && (
            <div className="step-1-content">
              <input 
                type="text" 
                placeholder="Enter your Agency NPN or License Number" 
                value={agencySearch}
          ...
          {showVerification && (
            <div style={{
              ...
              <div className="glass-card" style={{ maxWidth: '400px', width: '100%', textAlign: 'center', padding: '2rem', animation: 'slideIn 0.3s ease forwards' }}>
                <h3 style={{ fontSize: '1.3rem', marginBottom: '1rem', color: 'var(--text-main)', textTransform: 'uppercase', letterSpacing: '1px' }}>Dossier Ready</h3>
                <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', lineHeight: 1.5, fontSize: '0.9rem' }}>
                  Create your admin account to deploy the watchlist and initialize the Intelligence Dashboard.
                </p>
                <form onSubmit={finalizeClaim} style={{ textAlign: 'left' }}>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <label style={{ display: 'block', color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Admin Email</label>
                    <input 
                      type="email"
                      value={authEmail} onChange={e => setAuthEmail(e.target.value)}
                      style={{ width: '100%', background: 'rgba(0,0,0,0.5)', border: '1px solid var(--border-subtle)', color: 'white', padding: '0.8rem', borderRadius: '4px', outline: 'none' }}
                    />
                    {emailErrorText && (
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <label style={{ display: 'block', color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Secure Password</label>
                    <input 
                      type="password"
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    <label style={{ display: 'block', color: 'var(--text-muted)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', marginBottom: '0.5rem', textTransform: 'uppercase' }}>Confirm Password</label>
                    <input 
                      type="password"
                  ...
                  <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                    ...
                    <button type="submit" className="btn-primary-small" disabled={isLoading} style={{ flex: 2 }}>
